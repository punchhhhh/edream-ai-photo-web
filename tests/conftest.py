...
os.environ["ENTERPRISE_MEDIA_DIR"] = os.path.join(_tmpdir, "enterprise-media")
os.environ["ENTERPRISE_ADMIN_SUBS"] = "platform-admin"
os.environ["INTERNAL_SERVICE_TOKENS"] = "internal-test-token"
